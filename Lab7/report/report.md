...
![Схема однократного использования Вернама](../image/1.png){#fig:001 width=50%}
...
В ходе выполнения данной лабораторной работы я освоил на практике при-
менение режима однократного гаммирования

# Список литературы

1. Кулябов Д. С.  *Лабораторная работа №7**: 007-lab_crypto-gamma.pdf*
